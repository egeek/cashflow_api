...
# Unit tests for CashFlowsApi::RefundPaymentResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RefundPaymentResponse' do
  before do
    # run before each test
    @instance = CashFlowsApi::RefundPaymentResponse.new
  end
  ...
  describe 'test an instance of RefundPaymentResponse' do
    it 'should create an instance of RefundPaymentResponse' do
      expect(@instance).to be_instance_of(CashFlowsApi::RefundPaymentResponse)
    end
  end
