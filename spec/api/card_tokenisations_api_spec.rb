...
# Unit tests for CashFlowsApi::CardTokenisationsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CardTokenisationsApi' do
  before do
    # run before each test
    @instance = CashFlowsApi::CardTokenisationsApi.new
  end
  ...
  describe 'test an instance of CardTokenisationsApi' do
    it 'should create an instance of CardTokenisationsApi' do
      expect(@instance).to be_instance_of(CashFlowsApi::CardTokenisationsApi)
    end
  end
