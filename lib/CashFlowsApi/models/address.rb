...
module CashFlowsApi
  class Address
    ...
    attr_accessor :country_iso3166_alpha2
    ...
    def self.attribute_map
      {
        ...
        :'last_name' => :'lastName',
        :'country_iso3166_alpha2' => :'countryIso3166Alpha2',
        ...
        :'phone_number1_type' => :'phoneNumber1Type',
        :'phone_number2' => :'phoneNumber2',
        :'phone_number2_type' => :'phoneNumber2Type',
    ...
    def self.openapi_types
      {
        ...
        :'middle_name' => :'Object',
        :'last_name' => :'Object',
        :'country_iso3166_alpha2' => :'Object',
        :'address_line1' => :'Object',
        :'address_line2' => :'Object',
        :'zip_code' => :'Object',
        :'city' => :'Object',
        :'state_province' => :'Object',
        :'phone_number1' => :'Object',
        :'phone_number1_type' => :'Object',
        :'phone_number2' => :'Object',
        :'phone_number2_type' => :'Object',
        :'organisation' => :'Object',
        :'department' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CashFlowsApi::Address` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CashFlowsApi::Address`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'country_iso3166_alpha2')
        self.country_iso3166_alpha2 = attributes[:'country_iso3166_alpha2']
      end
      ...
      if attributes.key?(:'phone_number1_type')
        self.phone_number1_type = attributes[:'phone_number1_type']
      end
      ...
      if attributes.key?(:'phone_number2_type')
        self.phone_number2_type = attributes[:'phone_number2_type']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          country_iso3166_alpha2 == o.country_iso3166_alpha2 &&
          ...
          phone_number1_type == o.phone_number1_type &&
          phone_number2 == o.phone_number2 &&
          phone_number2_type == o.phone_number2_type &&
    ...
    def hash
      [title, first_name, middle_name, last_name, country_iso3166_alpha2, address_line1, address_line2, zip_code, city, state_province, phone_number1, phone_number1_type, phone_number2, phone_number2_type, organisation, department].hash
    end
