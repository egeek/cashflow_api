...
# Unit tests for SwaggerClient::CardTokenisationsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CardTokenisationsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::CardTokenisationsApi.new
  end
  ...
  describe 'test an instance of CardTokenisationsApi' do
    it 'should create an instance of CardTokenisationsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::CardTokenisationsApi)
    end
  end

  # unit tests for api_gateway_card_tokenisation_post
  ...
  describe 'api_gateway_card_tokenisation_post test' do
    it 'should work' do
