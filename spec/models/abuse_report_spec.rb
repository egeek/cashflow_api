...
# Unit tests for SwaggerClient::AbuseReport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AbuseReport' do
  before do
    # run before each test
    @instance = SwaggerClient::AbuseReport.new
  end
  ...
  describe 'test an instance of AbuseReport' do
    it 'should create an instance of AbuseReport' do
      expect(@instance).to be_instance_of(SwaggerClient::AbuseReport)
    end
  end
  ...
  describe 'test attribute "created_date_time_utc"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
