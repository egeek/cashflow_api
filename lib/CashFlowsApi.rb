...
# Common files
require 'CashFlowsApi/api_client'
require 'CashFlowsApi/api_error'
require 'CashFlowsApi/version'
require 'CashFlowsApi/configuration'

# Models
require 'CashFlowsApi/models/abuse_report'
require 'CashFlowsApi/models/abuse_trigger'
require 'CashFlowsApi/models/address'
require 'CashFlowsApi/models/capture'
require 'CashFlowsApi/models/capture_attributes'
require 'CashFlowsApi/models/capture_payment_request'
require 'CashFlowsApi/models/capture_payment_response'
require 'CashFlowsApi/models/capture_status'
require 'CashFlowsApi/models/card_token_data'
require 'CashFlowsApi/models/card_tokenisation_request'
require 'CashFlowsApi/models/card_tokenisation_response'
require 'CashFlowsApi/models/country'
require 'CashFlowsApi/models/create_payment_job_request'
require 'CashFlowsApi/models/create_payment_job_request_parameters'
require 'CashFlowsApi/models/currency'
require 'CashFlowsApi/models/entry'
require 'CashFlowsApi/models/error_report'
require 'CashFlowsApi/models/error_response'
require 'CashFlowsApi/models/gateway_payment_method'
require 'CashFlowsApi/models/gender'
require 'CashFlowsApi/models/identity'
require 'CashFlowsApi/models/issuer'
require 'CashFlowsApi/models/link'
require 'CashFlowsApi/models/links'
require 'CashFlowsApi/models/locale'
require 'CashFlowsApi/models/order'
require 'CashFlowsApi/models/order_line'
require 'CashFlowsApi/models/order_line_type'
require 'CashFlowsApi/models/payment'
require 'CashFlowsApi/models/payment_attributes'
require 'CashFlowsApi/models/payment_job'
require 'CashFlowsApi/models/payment_job_attributes'
require 'CashFlowsApi/models/payment_job_flags'
require 'CashFlowsApi/models/payment_job_option'
require 'CashFlowsApi/models/payment_job_response'
require 'CashFlowsApi/models/payment_job_type'
require 'CashFlowsApi/models/payment_method'
require 'CashFlowsApi/models/payment_method_info'
require 'CashFlowsApi/models/payment_response'
require 'CashFlowsApi/models/payment_status'
require 'CashFlowsApi/models/payment_step'
require 'CashFlowsApi/models/payment_step_action'
require 'CashFlowsApi/models/phone_number_type'
require 'CashFlowsApi/models/recurrence_criteria'
require 'CashFlowsApi/models/recurrence_type'
require 'CashFlowsApi/models/refund'
require 'CashFlowsApi/models/refund_attributes'
require 'CashFlowsApi/models/refund_payment_request'
require 'CashFlowsApi/models/refund_payment_response'
require 'CashFlowsApi/models/refund_status'
require 'CashFlowsApi/models/refund_step'
require 'CashFlowsApi/models/refund_step_action'
require 'CashFlowsApi/models/supported_payment_methods_response'
require 'CashFlowsApi/models/tokenised_card'
require 'CashFlowsApi/models/update_order_request'

# APIs
require 'CashFlowsApi/api/card_tokenisations_api'
require 'CashFlowsApi/api/orders_api'
require 'CashFlowsApi/api/payment_jobs_api'
require 'CashFlowsApi/api/supported_payment_methods_api'

module CashFlowsApi
  class << self
    # Customize default settings for the SDK using block.
    #   CashFlowsApi.configure do |config|
    #     config.username = "xxx"
    #     config.password = "xxx"
    #   end
