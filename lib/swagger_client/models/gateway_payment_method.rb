...
module SwaggerClient
  class GatewayPaymentMethod
    ...
    SEPA_BANKTRANSFER = 'SepaBanktransfer'.freeze
    KLARNA_PAY_LATER = 'KlarnaPayLater'.freeze
    KLARNA_SLICE_IT = 'KlarnaSliceIt'.freeze
    KLARNA_PAY_NOW = 'KlarnaPayNow'.freeze
    AFTER_PAY = 'AfterPay'.freeze
    ...
    def build_from_hash(value)
      constantValues = GatewayPaymentMethod.constants.select { |c| GatewayPaymentMethod::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #GatewayPaymentMethod" if constantValues.empty?
      value
    end
  end
end
