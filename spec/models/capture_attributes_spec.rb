...
# Unit tests for SwaggerClient::CaptureAttributes
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CaptureAttributes' do
  before do
    # run before each test
    @instance = SwaggerClient::CaptureAttributes.new
  end
  ...
  describe 'test an instance of CaptureAttributes' do
    it 'should create an instance of CaptureAttributes' do
      expect(@instance).to be_instance_of(SwaggerClient::CaptureAttributes)
    end
  end
