...
# Unit tests for CashFlowsApi::RecurrenceCriteria
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RecurrenceCriteria' do
  before do
    # run before each test
    @instance = CashFlowsApi::RecurrenceCriteria.new
  end
  ...
  describe 'test an instance of RecurrenceCriteria' do
    it 'should create an instance of RecurrenceCriteria' do
      expect(@instance).to be_instance_of(CashFlowsApi::RecurrenceCriteria)
    end
  end
