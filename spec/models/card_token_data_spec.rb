...
# Unit tests for SwaggerClient::CardTokenData
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CardTokenData' do
  before do
    # run before each test
    @instance = SwaggerClient::CardTokenData.new
  end
  ...
  describe 'test an instance of CardTokenData' do
    it 'should create an instance of CardTokenData' do
      expect(@instance).to be_instance_of(SwaggerClient::CardTokenData)
    end
  end
  ...
  describe 'test attribute "issuer_return_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "truncated_card_number"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
