...
# Unit tests for SwaggerClient::SupportedPaymentMethodsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SupportedPaymentMethodsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::SupportedPaymentMethodsApi.new
  end
  ...
  describe 'test an instance of SupportedPaymentMethodsApi' do
    it 'should create an instance of SupportedPaymentMethodsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::SupportedPaymentMethodsApi)
    end
  end

  # unit tests for api_gateway_supported_payment_methods_get
  ...
  describe 'api_gateway_supported_payment_methods_get test' do
    it 'should work' do
