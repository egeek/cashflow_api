...
# Unit tests for SwaggerClient::CreatePaymentJobRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreatePaymentJobRequest' do
  before do
    # run before each test
    @instance = SwaggerClient::CreatePaymentJobRequest.new
  end
  ...
  describe 'test an instance of CreatePaymentJobRequest' do
    it 'should create an instance of CreatePaymentJobRequest' do
      expect(@instance).to be_instance_of(SwaggerClient::CreatePaymentJobRequest)
    end
  end
  ...
  describe 'test attribute "preparation_ids"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
