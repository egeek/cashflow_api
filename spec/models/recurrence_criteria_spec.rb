...
# Unit tests for SwaggerClient::RecurrenceCriteria
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RecurrenceCriteria' do
  before do
    # run before each test
    @instance = SwaggerClient::RecurrenceCriteria.new
  end
  ...
  describe 'test an instance of RecurrenceCriteria' do
    it 'should create an instance of RecurrenceCriteria' do
      expect(@instance).to be_instance_of(SwaggerClient::RecurrenceCriteria)
    end
  end
  ...
  describe 'test attribute "recurring_expiry"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "instalments"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
