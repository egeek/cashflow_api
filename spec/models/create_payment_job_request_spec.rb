...
# Unit tests for CashFlowsApi::CreatePaymentJobRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreatePaymentJobRequest' do
  before do
    # run before each test
    @instance = CashFlowsApi::CreatePaymentJobRequest.new
  end
  ...
  describe 'test an instance of CreatePaymentJobRequest' do
    it 'should create an instance of CreatePaymentJobRequest' do
      expect(@instance).to be_instance_of(CashFlowsApi::CreatePaymentJobRequest)
    end
  end
