  ...
  class AbuseReport
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::AbuseReport` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::AbuseReport`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'created_date_time_utc')
        self.created_date_time_utc = attributes[:'created_date_time_utc']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          score == o.score &&
          triggers == o.triggers &&
          created_date_time_utc == o.created_date_time_utc
    end
    ...
    def hash
      [score, triggers, created_date_time_utc].hash
    end
