...
# Unit tests for CashFlowsApi::Order
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Order' do
  before do
    # run before each test
    @instance = CashFlowsApi::Order.new
  end
  ...
  describe 'test an instance of Order' do
    it 'should create an instance of Order' do
      expect(@instance).to be_instance_of(CashFlowsApi::Order)
    end
  end
  ...
  describe 'test attribute "billing_identity"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
