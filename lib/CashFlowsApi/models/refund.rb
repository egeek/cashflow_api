...
module CashFlowsApi
  class Refund
    ...
    attr_accessor :converted_amount_to_refund
    ...
    def self.attribute_map
      {
        ...
        :'converted_amount_to_refund' => :'convertedAmountToRefund',
    ...
    def self.openapi_types
      {
        ...
        :'refund_number' => :'Object',
        :'status' => :'Object',
        :'amount_to_refund' => :'Object',
        :'converted_amount_to_refund' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CashFlowsApi::Refund` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CashFlowsApi::Refund`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'refund_number')
        self.refund_number = attributes[:'refund_number']
      end
      ...
      if attributes.key?(:'amount_to_refund')
        self.amount_to_refund = attributes[:'amount_to_refund']
      end

      if attributes.key?(:'converted_amount_to_refund')
        self.converted_amount_to_refund = attributes[:'converted_amount_to_refund']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          refund_number == o.refund_number &&
          status == o.status &&
          amount_to_refund == o.amount_to_refund &&
          converted_amount_to_refund == o.converted_amount_to_refund &&
