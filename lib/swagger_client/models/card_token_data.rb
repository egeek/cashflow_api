...
module SwaggerClient
  ...
  class CardTokenData
    ...
    attr_accessor :issuer_return_code

    # The truncated card number.
    attr_accessor :truncated_card_number
    ...
    def self.attribute_map
      {
        ...
        :'issuer_return_code' => :'issuerReturnCode',
    ...
    def self.openapi_types
      {
        ...
        :'issuer_return_code' => :'Object',
        :'truncated_card_number' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::CardTokenData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::CardTokenData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'issuer_return_code')
        self.issuer_return_code = attributes[:'issuer_return_code']
      end

      if attributes.key?(:'truncated_card_number')
        self.truncated_card_number = attributes[:'truncated_card_number']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          issuer_return_code == o.issuer_return_code &&
          truncated_card_number == o.truncated_card_number
    end
    ...
    def hash
      [token, card_expiry_month, card_expiry_year, issuer_return_code, truncated_card_number].hash
    end
