...
# Unit tests for SwaggerClient::RefundAttributes
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RefundAttributes' do
  before do
    # run before each test
    @instance = SwaggerClient::RefundAttributes.new
  end
  ...
  describe 'test an instance of RefundAttributes' do
    it 'should create an instance of RefundAttributes' do
      expect(@instance).to be_instance_of(SwaggerClient::RefundAttributes)
    end
  end
