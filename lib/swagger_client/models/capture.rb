...
module SwaggerClient
  class Capture
    ...
    attr_accessor :converted_amount_to_capture
    ...
    attr_accessor :is_final_capture
    ...
    def self.attribute_map
      {
        ...
        :'converted_amount_to_capture' => :'convertedAmountToCapture',
    ...
    def self.openapi_types
      {
        ...
        :'converted_amount_to_capture' => :'Object',
        :'converted_currency' => :'Object',
        :'conversion_rate' => :'Object',
        :'is_final_capture' => :'Object',
        :'attributes' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::Capture` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::Capture`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'converted_amount_to_capture')
        self.converted_amount_to_capture = attributes[:'converted_amount_to_capture']
      end
      ...
      if attributes.key?(:'is_final_capture')
        self.is_final_capture = attributes[:'is_final_capture']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          converted_amount_to_capture == o.converted_amount_to_capture &&
          converted_currency == o.converted_currency &&
          conversion_rate == o.conversion_rate &&
          is_final_capture == o.is_final_capture &&
    ...
    def hash
      [reference, create_date_time_utc, status, amount_to_capture, converted_amount_to_capture, converted_currency, conversion_rate, is_final_capture, attributes].hash
    end
