...
# Unit tests for CashFlowsApi::PaymentAttributes
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentAttributes' do
  before do
    # run before each test
    @instance = CashFlowsApi::PaymentAttributes.new
  end
  ...
  describe 'test an instance of PaymentAttributes' do
    it 'should create an instance of PaymentAttributes' do
      expect(@instance).to be_instance_of(CashFlowsApi::PaymentAttributes)
    end
  end
