...
# Unit tests for SwaggerClient::Capture
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Capture' do
  before do
    # run before each test
    @instance = SwaggerClient::Capture.new
  end
  ...
  describe 'test an instance of Capture' do
    it 'should create an instance of Capture' do
      expect(@instance).to be_instance_of(SwaggerClient::Capture)
    end
  end
  ...
  describe 'test attribute "converted_amount_to_capture"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "is_final_capture"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
