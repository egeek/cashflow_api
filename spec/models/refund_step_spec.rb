...
# Unit tests for SwaggerClient::RefundStep
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RefundStep' do
  before do
    # run before each test
    @instance = SwaggerClient::RefundStep.new
  end
  ...
  describe 'test an instance of RefundStep' do
    it 'should create an instance of RefundStep' do
      expect(@instance).to be_instance_of(SwaggerClient::RefundStep)
    end
  end
  ...
  describe 'test attribute "result_attributes"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
