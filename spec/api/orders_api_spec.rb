...
# Unit tests for CashFlowsApi::OrdersApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrdersApi' do
  before do
    # run before each test
    @instance = CashFlowsApi::OrdersApi.new
  end
  ...
  describe 'test an instance of OrdersApi' do
    it 'should create an instance of OrdersApi' do
      expect(@instance).to be_instance_of(CashFlowsApi::OrdersApi)
    end
  end

  # unit tests for api_gateway_orders_order_number_head
  ...
  # @return [nil]
  describe 'api_gateway_orders_order_number_head test' do
    it 'should work' do
