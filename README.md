...
SwaggerClient - the Ruby gem for the Payment Gateway API
...
------------ | ------------- | ------------- | -------------
*SwaggerClient::CardTokenisationsApi* | [**api_gateway_card_tokenisation_post**](docs/CardTokenisationsApi.md#api_gateway_card_tokenisation_post) | **POST** /api/gateway/card-tokenisation | 
*SwaggerClient::OrdersApi* | [**api_gateway_orders_order_number_head**](docs/OrdersApi.md#api_gateway_orders_order_number_head) | **HEAD** /api/gateway/orders/{orderNumber} | Checks if the order exists, but does not return it.
*SwaggerClient::PaymentJobsApi* | [**api_gateway_payment_jobs_payment_job_reference_cancel_patch**](docs/PaymentJobsApi.md#api_gateway_payment_jobs_payment_job_reference_cancel_patch) | **PATCH** /api/gateway/payment-jobs/{paymentJobReference}/cancel | Cancels a payment job.
*SwaggerClient::PaymentJobsApi* | [**api_gateway_payment_jobs_payment_job_reference_get**](docs/PaymentJobsApi.md#api_gateway_payment_jobs_payment_job_reference_get) | **GET** /api/gateway/payment-jobs/{paymentJobReference} | Retrieves a payment job.
...
*SwaggerClient::PaymentJobsApi* | [**api_gateway_payment_jobs_post**](docs/PaymentJobsApi.md#api_gateway_payment_jobs_post) | **POST** /api/gateway/payment-jobs | Creates a new payment job.
*SwaggerClient::SupportedPaymentMethodsApi* | [**api_gateway_supported_payment_methods_get**](docs/SupportedPaymentMethodsApi.md#api_gateway_supported_payment_methods_get) | **GET** /api/gateway/supported-payment-methods | Retrieve supported payment methods

## Documentation for Models

 - [SwaggerClient::AbuseReport](docs/AbuseReport.md)
 - [SwaggerClient::AbuseTrigger](docs/AbuseTrigger.md)
 - [SwaggerClient::Address](docs/Address.md)
 - [SwaggerClient::Capture](docs/Capture.md)
 - [SwaggerClient::CaptureAttributes](docs/CaptureAttributes.md)
 - [SwaggerClient::CapturePaymentRequest](docs/CapturePaymentRequest.md)
 - [SwaggerClient::CapturePaymentResponse](docs/CapturePaymentResponse.md)
 - [SwaggerClient::CaptureStatus](docs/CaptureStatus.md)
 - [SwaggerClient::CardTokenData](docs/CardTokenData.md)
 - [SwaggerClient::CardTokenisationRequest](docs/CardTokenisationRequest.md)
 - [SwaggerClient::CardTokenisationResponse](docs/CardTokenisationResponse.md)
 - [SwaggerClient::Country](docs/Country.md)
 - [SwaggerClient::CreatePaymentJobRequest](docs/CreatePaymentJobRequest.md)
 - [SwaggerClient::CreatePaymentJobRequestParameters](docs/CreatePaymentJobRequestParameters.md)
 - [SwaggerClient::Currency](docs/Currency.md)
 - [SwaggerClient::Entry](docs/Entry.md)
 - [SwaggerClient::ErrorReport](docs/ErrorReport.md)
 - [SwaggerClient::ErrorResponse](docs/ErrorResponse.md)
 - [SwaggerClient::GatewayPaymentMethod](docs/GatewayPaymentMethod.md)
 - [SwaggerClient::Gender](docs/Gender.md)
 - [SwaggerClient::Identity](docs/Identity.md)
 - [SwaggerClient::Issuer](docs/Issuer.md)
 - [SwaggerClient::Link](docs/Link.md)
 - [SwaggerClient::Links](docs/Links.md)
 - [SwaggerClient::Locale](docs/Locale.md)
 - [SwaggerClient::Order](docs/Order.md)
 - [SwaggerClient::OrderLine](docs/OrderLine.md)
 - [SwaggerClient::OrderLineType](docs/OrderLineType.md)
 - [SwaggerClient::Payment](docs/Payment.md)
 - [SwaggerClient::PaymentAttributes](docs/PaymentAttributes.md)
 - [SwaggerClient::PaymentJob](docs/PaymentJob.md)
 - [SwaggerClient::PaymentJobAttributes](docs/PaymentJobAttributes.md)
 - [SwaggerClient::PaymentJobFlags](docs/PaymentJobFlags.md)
 - [SwaggerClient::PaymentJobOption](docs/PaymentJobOption.md)
 - [SwaggerClient::PaymentJobResponse](docs/PaymentJobResponse.md)
 - [SwaggerClient::PaymentJobType](docs/PaymentJobType.md)
 - [SwaggerClient::PaymentMethod](docs/PaymentMethod.md)
 - [SwaggerClient::PaymentMethodInfo](docs/PaymentMethodInfo.md)
 - [SwaggerClient::PaymentResponse](docs/PaymentResponse.md)
 - [SwaggerClient::PaymentStatus](docs/PaymentStatus.md)
 - [SwaggerClient::PaymentStep](docs/PaymentStep.md)
 - [SwaggerClient::PaymentStepAction](docs/PaymentStepAction.md)
 - [SwaggerClient::PhoneNumberType](docs/PhoneNumberType.md)
 - [SwaggerClient::RecurrenceCriteria](docs/RecurrenceCriteria.md)
 - [SwaggerClient::RecurrenceType](docs/RecurrenceType.md)
 - [SwaggerClient::Refund](docs/Refund.md)
 - [SwaggerClient::RefundAttributes](docs/RefundAttributes.md)
 - [SwaggerClient::RefundPaymentRequest](docs/RefundPaymentRequest.md)
 - [SwaggerClient::RefundPaymentResponse](docs/RefundPaymentResponse.md)
 - [SwaggerClient::RefundStatus](docs/RefundStatus.md)
 - [SwaggerClient::RefundStep](docs/RefundStep.md)
 - [SwaggerClient::RefundStepAction](docs/RefundStepAction.md)
 - [SwaggerClient::SupportedPaymentMethodsResponse](docs/SupportedPaymentMethodsResponse.md)
 - [SwaggerClient::TokenisedCard](docs/TokenisedCard.md)
 - [SwaggerClient::UpdateOrderRequest](docs/UpdateOrderRequest.md)
