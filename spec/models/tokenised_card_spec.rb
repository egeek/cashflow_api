...
# Unit tests for SwaggerClient::TokenisedCard
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TokenisedCard' do
  before do
    # run before each test
    @instance = SwaggerClient::TokenisedCard.new
  end
  ...
  describe 'test an instance of TokenisedCard' do
    it 'should create an instance of TokenisedCard' do
      expect(@instance).to be_instance_of(SwaggerClient::TokenisedCard)
    end
  end
