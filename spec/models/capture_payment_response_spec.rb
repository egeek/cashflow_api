...
# Unit tests for CashFlowsApi::CapturePaymentResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CapturePaymentResponse' do
  before do
    # run before each test
    @instance = CashFlowsApi::CapturePaymentResponse.new
  end
  ...
  describe 'test an instance of CapturePaymentResponse' do
    it 'should create an instance of CapturePaymentResponse' do
      expect(@instance).to be_instance_of(CashFlowsApi::CapturePaymentResponse)
    end
  end
