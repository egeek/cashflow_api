...
# Unit tests for CashFlowsApi::PaymentMethodInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentMethodInfo' do
  before do
    # run before each test
    @instance = CashFlowsApi::PaymentMethodInfo.new
  end
  ...
  describe 'test an instance of PaymentMethodInfo' do
    it 'should create an instance of PaymentMethodInfo' do
      expect(@instance).to be_instance_of(CashFlowsApi::PaymentMethodInfo)
    end
  end
