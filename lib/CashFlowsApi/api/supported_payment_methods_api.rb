...
module CashFlowsApi
  class SupportedPaymentMethodsApi
    ...
    # @option opts [String] :configuration_id 
    # @option opts [String] :hash 
    # @option opts [Float] :collect_amount 
    # @option opts [Currency] :currency 
    # @option opts [BOOLEAN] :all 
    # @option opts [Integer] :customer_reference 
    # @option opts [Locale] :locale 
    # @return [SupportedPaymentMethodsResponse]
    def api_gateway_supported_payment_methods_get(opts = {})
      data, _status_code, _headers = api_gateway_supported_payment_methods_get_with_http_info(opts)
      data
    end
    ...
    # @option opts [Integer] :customer_reference 
    # @option opts [Locale] :locale 
    # @return [Array<(SupportedPaymentMethodsResponse, Integer, Hash)>] SupportedPaymentMethodsResponse data, response status code and response headers
    def api_gateway_supported_payment_methods_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SupportedPaymentMethodsApi.api_gateway_supported_payment_methods_get ...'
      end
      # resource path
      local_var_path = '/api/gateway/supported-payment-methods'

      # query parameters
      query_params = opts[:query_params] || {}
      query_params[:'collectAmount'] = opts[:'collect_amount'] if !opts[:'collect_amount'].nil?
      ...
      return_type = opts[:return_type] || 'SupportedPaymentMethodsResponse' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SupportedPaymentMethodsApi#api_gateway_supported_payment_methods_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
