...
module SwaggerClient
  ...
  class UpdateOrderRequest
    ...
    attr_accessor :billing_identity
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::UpdateOrderRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::UpdateOrderRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'billing_identity')
        self.billing_identity = attributes[:'billing_identity']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          billing_identity == o.billing_identity &&
    ...
    def hash
      [order_number, note, customer_reference, billing_address, billing_identity, shipping_address, order_lines].hash
    end
