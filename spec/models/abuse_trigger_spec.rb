...
# Unit tests for SwaggerClient::AbuseTrigger
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AbuseTrigger' do
  before do
    # run before each test
    @instance = SwaggerClient::AbuseTrigger.new
  end
  ...
  describe 'test an instance of AbuseTrigger' do
    it 'should create an instance of AbuseTrigger' do
      expect(@instance).to be_instance_of(SwaggerClient::AbuseTrigger)
    end
  end
