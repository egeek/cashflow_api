...
# Unit tests for SwaggerClient::PaymentJobAttributes
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentJobAttributes' do
  before do
    # run before each test
    @instance = SwaggerClient::PaymentJobAttributes.new
  end
  ...
  describe 'test an instance of PaymentJobAttributes' do
    it 'should create an instance of PaymentJobAttributes' do
      expect(@instance).to be_instance_of(SwaggerClient::PaymentJobAttributes)
    end
  end
