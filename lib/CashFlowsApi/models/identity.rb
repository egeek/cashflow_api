...
module CashFlowsApi
  class Identity
    ...
    attr_accessor :chamber_of_commerce_number
    ...
    def self.openapi_types
      {
        ...
        :'chamber_of_commerce_number' => :'Object',
        :'vat_number' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `CashFlowsApi::Identity` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `CashFlowsApi::Identity`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'debtor_id')
        self.debtor_id = attributes[:'debtor_id']
      end
      ...
      if attributes.key?(:'chamber_of_commerce_number')
        self.chamber_of_commerce_number = attributes[:'chamber_of_commerce_number']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          chamber_of_commerce_number == o.chamber_of_commerce_number &&
    ...
    def hash
      [debtor_id, email_address, gender, date_of_birth, social_security_number, chamber_of_commerce_number, vat_number].hash
    end
