...
# Unit tests for CashFlowsApi::SupportedPaymentMethodsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SupportedPaymentMethodsApi' do
  before do
    # run before each test
    @instance = CashFlowsApi::SupportedPaymentMethodsApi.new
  end
  ...
  describe 'test an instance of SupportedPaymentMethodsApi' do
    it 'should create an instance of SupportedPaymentMethodsApi' do
      expect(@instance).to be_instance_of(CashFlowsApi::SupportedPaymentMethodsApi)
    end
  end
