...
module SwaggerClient
  ...
  class PaymentMethodInfo
    ...
    attr_accessor :supports_tokenisation
    ...
    attr_accessor :surcharge_amount_excl_vat

    # The amount of value-added tax in the surcharge amount.
    attr_accessor :surcharge_amount_vat

    # The surcharge vat percentage.
    attr_accessor :surcharge_vat_percentage
    ...
    def self.attribute_map
      {
        ...
        :'supports_tokenisation' => :'supportsTokenisation',
        :'tokenized_cards' => :'tokenizedCards',
        :'currencies' => :'currencies',
        :'surcharge_amount' => :'surchargeAmount',
        :'surcharge_amount_excl_vat' => :'surchargeAmountExclVat',
        :'surcharge_amount_vat' => :'surchargeAmountVat',
        :'surcharge_vat_percentage' => :'surchargeVatPercentage',
    ...
    def self.openapi_types
      {
        ...
        :'logo' => :'Object',
        :'issuer_list' => :'Object',
        :'supports_tokenisation' => :'Object',
        :'tokenized_cards' => :'Object',
        :'currencies' => :'Object',
        :'surcharge_amount' => :'Object',
        :'surcharge_amount_excl_vat' => :'Object',
        :'surcharge_amount_vat' => :'Object',
        :'surcharge_vat_percentage' => :'Object',
        :'description' => :'Object'
      }
    end
    ...
    def self.openapi_nullable
      Set.new([
        ...
        :'tokenized_cards',
        :'surcharge_amount',
        :'surcharge_amount_excl_vat',
        :'surcharge_amount_vat',
        :'surcharge_vat_percentage',
        :'description'
      ])
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::PaymentMethodInfo` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::PaymentMethodInfo`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'issuer_list')
        if (value = attributes[:'issuer_list']).is_a?(Array)
          self.issuer_list = value
        end
      end

      if attributes.key?(:'supports_tokenisation')
        self.supports_tokenisation = attributes[:'supports_tokenisation']
      end

      if attributes.key?(:'tokenized_cards')
        if (value = attributes[:'tokenized_cards']).is_a?(Array)
          self.tokenized_cards = value
        end
      end
      ...
      if attributes.key?(:'surcharge_amount_excl_vat')
        self.surcharge_amount_excl_vat = attributes[:'surcharge_amount_excl_vat']
      end

      if attributes.key?(:'surcharge_amount_vat')
        self.surcharge_amount_vat = attributes[:'surcharge_amount_vat']
      end

      if attributes.key?(:'surcharge_vat_percentage')
        self.surcharge_vat_percentage = attributes[:'surcharge_vat_percentage']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          logo == o.logo &&
          issuer_list == o.issuer_list &&
          supports_tokenisation == o.supports_tokenisation &&
          tokenized_cards == o.tokenized_cards &&
          currencies == o.currencies &&
          surcharge_amount == o.surcharge_amount &&
          surcharge_amount_excl_vat == o.surcharge_amount_excl_vat &&
          surcharge_amount_vat == o.surcharge_amount_vat &&
          surcharge_vat_percentage == o.surcharge_vat_percentage &&
    ...
    def hash
      [payment_method, logo, issuer_list, supports_tokenisation, tokenized_cards, currencies, surcharge_amount, surcharge_amount_excl_vat, surcharge_amount_vat, surcharge_vat_percentage, description].hash
    end
