...
# Unit tests for SwaggerClient::PaymentJobsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentJobsApi' do
  before do
    # run before each test
    @instance = SwaggerClient::PaymentJobsApi.new
  end
  ...
  describe 'test an instance of PaymentJobsApi' do
    it 'should create an instance of PaymentJobsApi' do
      expect(@instance).to be_instance_of(SwaggerClient::PaymentJobsApi)
    end
  end

  # unit tests for api_gateway_payment_jobs_payment_job_reference_cancel_patch
  ...
  describe 'api_gateway_payment_jobs_payment_job_reference_cancel_patch test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for api_gateway_payment_jobs_payment_job_reference_get
  ...
  # @option opts [Locale] :locale The locale to translate errors and warnings to.
  # @return [PaymentJobResponse]
  describe 'api_gateway_payment_jobs_payment_job_reference_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for api_gateway_payment_jobs_payment_job_reference_payments_payment_reference_cancel_patch
  # Cancels a payment.
  ...
  describe 'api_gateway_payment_jobs_payment_job_reference_payments_payment_reference_cancel_patch test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for api_gateway_payment_jobs_payment_job_reference_payments_payment_reference_captures_post
  ...
  describe 'api_gateway_payment_jobs_payment_job_reference_payments_payment_reference_captures_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for api_gateway_payment_jobs_payment_job_reference_payments_payment_reference_get
  # Retrieves a payment.
  ...
  # @option opts [Locale] :locale The locale to translate errors and warnings to.
  # @return [PaymentResponse]
  describe 'api_gateway_payment_jobs_payment_job_reference_payments_payment_reference_get test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for api_gateway_payment_jobs_payment_job_reference_payments_payment_reference_refunds_post
  ...
  describe 'api_gateway_payment_jobs_payment_job_reference_payments_payment_reference_refunds_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for api_gateway_payment_jobs_post
  ...
  # @option opts [Locale] :locale The locale to translate errors and warnings to.
  # @return [PaymentJobResponse]
  describe 'api_gateway_payment_jobs_post test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
