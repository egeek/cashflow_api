...
# Unit tests for CashFlowsApi::Identity
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Identity' do
  before do
    # run before each test
    @instance = CashFlowsApi::Identity.new
  end
  ...
  describe 'test an instance of Identity' do
    it 'should create an instance of Identity' do
      expect(@instance).to be_instance_of(CashFlowsApi::Identity)
    end
  end
  describe 'test attribute "debtor_id"' do
    it 'should work' do
  ...
  describe 'test attribute "chamber_of_commerce_number"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
