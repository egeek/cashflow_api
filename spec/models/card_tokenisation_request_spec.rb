...
# Unit tests for CashFlowsApi::CardTokenisationRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CardTokenisationRequest' do
  before do
    # run before each test
    @instance = CashFlowsApi::CardTokenisationRequest.new
  end
  ...
  describe 'test an instance of CardTokenisationRequest' do
    it 'should create an instance of CardTokenisationRequest' do
      expect(@instance).to be_instance_of(CashFlowsApi::CardTokenisationRequest)
    end
  end
