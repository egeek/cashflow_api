...
# Unit tests for CashFlowsApi::Refund
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Refund' do
  before do
    # run before each test
    @instance = CashFlowsApi::Refund.new
  end
  ...
  describe 'test an instance of Refund' do
    it 'should create an instance of Refund' do
      expect(@instance).to be_instance_of(CashFlowsApi::Refund)
    end
  end
  ...
  describe 'test attribute "refund_number"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "converted_amount_to_refund"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
