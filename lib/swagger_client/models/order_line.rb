...
module SwaggerClient
  class OrderLine
    ...
    attr_accessor :unit_price_excl_vat
    ...
    attr_accessor :vat_percentage_label

    # Discount percentage to display.
    attr_accessor :discount_percentage_label
    ...
    def self.attribute_map
      {
        ...
        :'vat_percentage_label' => :'vatPercentageLabel',
        :'discount_percentage_label' => :'discountPercentageLabel',
    ...
    def self.openapi_types
      {
        ...
        :'description' => :'Object',
        :'quantity' => :'Object',
        :'unit_price_excl_vat' => :'Object',
        :'unit_price_incl_vat' => :'Object',
        :'vat_percentage' => :'Object',
        :'vat_percentage_label' => :'Object',
        :'discount_percentage_label' => :'Object',
        :'total_line_amount' => :'Object',
        :'url' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::OrderLine` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::OrderLine`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'sku_code')
        self.sku_code = attributes[:'sku_code']
      end
      ...
      if attributes.key?(:'unit_price_excl_vat')
        self.unit_price_excl_vat = attributes[:'unit_price_excl_vat']
      end
      ...
      if attributes.key?(:'vat_percentage')
        self.vat_percentage = attributes[:'vat_percentage']
      end

      if attributes.key?(:'vat_percentage_label')
        self.vat_percentage_label = attributes[:'vat_percentage_label']
      end

      if attributes.key?(:'discount_percentage_label')
        self.discount_percentage_label = attributes[:'discount_percentage_label']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          quantity == o.quantity &&
          unit_price_excl_vat == o.unit_price_excl_vat &&
          unit_price_incl_vat == o.unit_price_incl_vat &&
          vat_percentage == o.vat_percentage &&
          vat_percentage_label == o.vat_percentage_label &&
          discount_percentage_label == o.discount_percentage_label &&
    ...
    def hash
      [line_number, type, sku_code, name, description, quantity, unit_price_excl_vat, unit_price_incl_vat, vat_percentage, vat_percentage_label, discount_percentage_label, total_line_amount, url].hash
    end
