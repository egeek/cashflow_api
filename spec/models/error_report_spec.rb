...
# Unit tests for SwaggerClient::ErrorReport
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ErrorReport' do
  before do
    # run before each test
    @instance = SwaggerClient::ErrorReport.new
  end
  ...
  describe 'test an instance of ErrorReport' do
    it 'should create an instance of ErrorReport' do
      expect(@instance).to be_instance_of(SwaggerClient::ErrorReport)
    end
  end
  ...
  describe 'test attribute "is_fatal_error"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
