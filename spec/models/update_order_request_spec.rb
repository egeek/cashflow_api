...
# Unit tests for CashFlowsApi::UpdateOrderRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateOrderRequest' do
  before do
    # run before each test
    @instance = CashFlowsApi::UpdateOrderRequest.new
  end
  ...
  describe 'test an instance of UpdateOrderRequest' do
    it 'should create an instance of UpdateOrderRequest' do
      expect(@instance).to be_instance_of(CashFlowsApi::UpdateOrderRequest)
    end
  end
