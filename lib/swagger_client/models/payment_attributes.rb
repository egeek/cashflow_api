...
module SwaggerClient
  ...
  class PaymentAttributes
    ...
    attr_accessor :payment_method_transaction_id

    attr_accessor :payment_method_void_transaction_id

    attr_accessor :token

    attr_accessor :cash_flows_acquiring_details
    ...
    def self.attribute_map
      {
        ...
        :'ideal_bic' => :'IdealBic',
        :'payment_method_transaction_id' => :'PaymentMethodTransactionId',
        :'payment_method_void_transaction_id' => :'PaymentMethodVoidTransactionId',
        :'token' => :'Token',
        :'cash_flows_acquiring_details' => :'CashFlowsAcquiringDetails',
    ...
    def self.openapi_types
      {
        ...
        :'ideal_bic' => :'Object',
        :'payment_method_transaction_id' => :'Object',
        :'payment_method_void_transaction_id' => :'Object',
        :'token' => :'Object',
        :'cash_flows_acquiring_details' => :'Object',
        :'descriptor' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::PaymentAttributes` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::PaymentAttributes`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'payment_method_transaction_id')
        self.payment_method_transaction_id = attributes[:'payment_method_transaction_id']
      end

      if attributes.key?(:'payment_method_void_transaction_id')
        self.payment_method_void_transaction_id = attributes[:'payment_method_void_transaction_id']
      end
      ...
      if attributes.key?(:'cash_flows_acquiring_details')
        self.cash_flows_acquiring_details = attributes[:'cash_flows_acquiring_details']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          payment_method_transaction_id == o.payment_method_transaction_id &&
          payment_method_void_transaction_id == o.payment_method_void_transaction_id &&
          token == o.token &&
          cash_flows_acquiring_details == o.cash_flows_acquiring_details &&
    ...
    def hash
      [originating_ip_address, origin_header, user_agent, return_url_success, return_url_failed, return_url_cancelled, simulated_status, ideal_bic, payment_method_transaction_id, payment_method_void_transaction_id, token, cash_flows_acquiring_details, descriptor, e_wallet_type].hash
    end
