...
module SwaggerClient
  # Flags that apply to this payment job.  They can either not be set or set with a true or false value.
  class PaymentJobFlags
    attr_accessor :payment_abandonment_email_sent

    attr_accessor :paid_by_payment_abandonment_email

    attr_accessor :moto

    attr_accessor :apple_pay

    attr_accessor :forced_moto

    attr_accessor :recurring_parent

    attr_accessor :direct

    attr_accessor :generate_token

    attr_accessor :store_card_details

    attr_accessor :created_on_mapi
    ...
    def self.attribute_map
      {
        :'payment_abandonment_email_sent' => :'PaymentAbandonmentEmailSent',
        :'paid_by_payment_abandonment_email' => :'PaidByPaymentAbandonmentEmail',
        :'moto' => :'Moto',
        :'apple_pay' => :'ApplePay',
        :'forced_moto' => :'ForcedMoto',
        :'recurring_parent' => :'RecurringParent',
        :'direct' => :'Direct',
        :'generate_token' => :'GenerateToken',
        :'store_card_details' => :'StoreCardDetails',
        :'created_on_mapi' => :'CreatedOnMapi',
    ...
    def self.openapi_types
      {
        :'payment_abandonment_email_sent' => :'Object',
        :'paid_by_payment_abandonment_email' => :'Object',
        :'moto' => :'Object',
        :'apple_pay' => :'Object',
        :'forced_moto' => :'Object',
        :'recurring_parent' => :'Object',
        :'direct' => :'Object',
        :'generate_token' => :'Object',
        :'store_card_details' => :'Object',
        :'created_on_mapi' => :'Object',
        :'frictionless' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::PaymentJobFlags` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::PaymentJobFlags`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'payment_abandonment_email_sent')
        self.payment_abandonment_email_sent = attributes[:'payment_abandonment_email_sent']
      end

      if attributes.key?(:'paid_by_payment_abandonment_email')
        self.paid_by_payment_abandonment_email = attributes[:'paid_by_payment_abandonment_email']
      end
      ...
      if attributes.key?(:'forced_moto')
        self.forced_moto = attributes[:'forced_moto']
      end

      if attributes.key?(:'recurring_parent')
        self.recurring_parent = attributes[:'recurring_parent']
      end
      ...
      if attributes.key?(:'store_card_details')
        self.store_card_details = attributes[:'store_card_details']
      end

      if attributes.key?(:'created_on_mapi')
        self.created_on_mapi = attributes[:'created_on_mapi']
      end

      if attributes.key?(:'frictionless')
        self.frictionless = attributes[:'frictionless']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          payment_abandonment_email_sent == o.payment_abandonment_email_sent &&
          paid_by_payment_abandonment_email == o.paid_by_payment_abandonment_email &&
          moto == o.moto &&
          apple_pay == o.apple_pay &&
          forced_moto == o.forced_moto &&
          recurring_parent == o.recurring_parent &&
          direct == o.direct &&
          generate_token == o.generate_token &&
          store_card_details == o.store_card_details &&
          created_on_mapi == o.created_on_mapi &&
          frictionless == o.frictionless
    end
    ...
    def hash
      [payment_abandonment_email_sent, paid_by_payment_abandonment_email, moto, apple_pay, forced_moto, recurring_parent, direct, generate_token, store_card_details, created_on_mapi, frictionless].hash
    end
