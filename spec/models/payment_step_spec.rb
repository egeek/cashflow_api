...
# Unit tests for SwaggerClient::PaymentStep
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentStep' do
  before do
    # run before each test
    @instance = SwaggerClient::PaymentStep.new
  end
  ...
  describe 'test an instance of PaymentStep' do
    it 'should create an instance of PaymentStep' do
      expect(@instance).to be_instance_of(SwaggerClient::PaymentStep)
    end
  end
