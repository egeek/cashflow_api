...
module SwaggerClient
  class CardTokenisationsApi
    ...
    # @option opts [CardTokenisationRequest] :body 
    # @option opts [String] :configuration_id 
    # @option opts [String] :hash 
    # @option opts [Locale] :locale 
    # @return [CardTokenisationResponse]
    def api_gateway_card_tokenisation_post(opts = {})
      data, _status_code, _headers = api_gateway_card_tokenisation_post_with_http_info(opts)
      data
    end
    ...
    def api_gateway_card_tokenisation_post_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CardTokenisationsApi.api_gateway_card_tokenisation_post ...'
      end
      # resource path
      local_var_path = '/api/gateway/card-tokenisation'
      ...
      return_type = opts[:return_type] || 'CardTokenisationResponse' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CardTokenisationsApi#api_gateway_card_tokenisation_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
