...
# Unit tests for SwaggerClient::PaymentAttributes
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentAttributes' do
  before do
    # run before each test
    @instance = SwaggerClient::PaymentAttributes.new
  end
  ...
  describe 'test an instance of PaymentAttributes' do
    it 'should create an instance of PaymentAttributes' do
      expect(@instance).to be_instance_of(SwaggerClient::PaymentAttributes)
    end
  end
  ...
  describe 'test attribute "payment_method_transaction_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "payment_method_void_transaction_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "cash_flows_acquiring_details"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
