...
# Unit tests for SwaggerClient::CardTokenisationResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CardTokenisationResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CardTokenisationResponse.new
  end
  ...
  describe 'test an instance of CardTokenisationResponse' do
    it 'should create an instance of CardTokenisationResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CardTokenisationResponse)
    end
  end
