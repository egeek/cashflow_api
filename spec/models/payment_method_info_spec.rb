...
# Unit tests for SwaggerClient::PaymentMethodInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentMethodInfo' do
  before do
    # run before each test
    @instance = SwaggerClient::PaymentMethodInfo.new
  end
  ...
  describe 'test an instance of PaymentMethodInfo' do
    it 'should create an instance of PaymentMethodInfo' do
      expect(@instance).to be_instance_of(SwaggerClient::PaymentMethodInfo)
    end
  end
  ...
  describe 'test attribute "issuer_list"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "supports_tokenisation"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "surcharge_amount_excl_vat"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "surcharge_amount_vat"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "surcharge_vat_percentage"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
