...
# Unit tests for CashFlowsApi::SupportedPaymentMethodsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SupportedPaymentMethodsResponse' do
  before do
    # run before each test
    @instance = CashFlowsApi::SupportedPaymentMethodsResponse.new
  end
  ...
  describe 'test an instance of SupportedPaymentMethodsResponse' do
    it 'should create an instance of SupportedPaymentMethodsResponse' do
      expect(@instance).to be_instance_of(CashFlowsApi::SupportedPaymentMethodsResponse)
    end
  end
