...
# Unit tests for CashFlowsApi::PaymentJobResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentJobResponse' do
  before do
    # run before each test
    @instance = CashFlowsApi::PaymentJobResponse.new
  end
  ...
  describe 'test an instance of PaymentJobResponse' do
    it 'should create an instance of PaymentJobResponse' do
      expect(@instance).to be_instance_of(CashFlowsApi::PaymentJobResponse)
    end
  end
